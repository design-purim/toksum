...
> **진행 상태(2026-09-14): Stage 0~4 완료 · Stage 5(배포·실기기)부터 남음.** 상세는 CHANGELOG v0.17.
...
### Stage 5 — 배포 + 실기기 설치 (여기서 처음으로 폰 등장)
- [ ] `git push` → Pages 재빌드(실측 ~30초) → `gh api repos/design-purim/toksum/pages/builds/latest --jq .status`
